...
const fallbackReviews: Review[] = [
  {
    ...
    rating: 5,
    review_text: 'Absolutely stunning work! My wedding makeup was flawless and lasted all night. Could not have asked for a better experience.',
    service_type: 'Bridal',
  },
  {
    id: '2',
    ...
    rating: 5,
    review_text: 'The attention to detail is incredible. She really listened to what I wanted and exceeded my expectations for the gala.',
    service_type: 'Special Events',
  },
  {
    id: '3',
    ...
    rating: 5,
    review_text: 'A true artist! The editorial look she created for my photoshoot was exactly what I envisioned and more.',
  ...
  },
  {
    ...
    rating: 5,
    review_text: 'She made me feel so beautiful on my special day. The bridal trial was thorough and she perfected every detail.',
    service_type: 'Bridal',
  },
];
